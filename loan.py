...
st.markdown("<h4 style = 'margin: -30px; color: #B30000; text-align: center; font-family: italic'>Built By Tech Titans</h4>", unsafe_allow_html = True)

st.markdown("<br>", unsafe_allow_html=True)

# #add image
st.image('pngwing.com (3).png', caption ='Built by Tech Titans')
...
if st.button('Check Your Loan Approval Status'):
    if predict[0] == 0:
        ...
        st.image('declined.png', width = 300)
    else:
        st.success(f"Congratulations... Your loan of {LoanAmount} dollar has been approved. Please proceed to any of our offices to process your loan")
